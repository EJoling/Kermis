class LadderKlimmen extends Attractie implements GokAttractie {
	private int belasting;// = kansSpelBelastingBetalen(getMoney());
	...
	public int kansSpelBelastingBetalen(int money) {
		if (this.getAantalKaartjes() > 0) {
				...
				System.out.println("Aantal kaartjes verkocht waarover belasting betaald kan worden. " + aantalBelastbareKaartjes);
				...
				aantalNietBelastbareKaartjes = this.getAantalKaartjes();
