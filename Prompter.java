...
class Prompter {
	...
	static void keuzeAttractieBericht() {
		...
		System.out.println("[b] BelastingInspecteur \t[o] Omzet\t \t[k] Aantal kaartjes\t\t[q] Kermis verlaten");
	}// end keuzeAttractie
	...
	static void monteur(String naam) {
		...
		System.out.println("Je kan het ook niet doen door op [n] te drukken, maar dan doet de attractie " + naam
				+ " het ook niet.");
	}
